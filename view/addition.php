<div class="container center-container">
    <h1>Additions</h1>
    <h2>Type of addition</h2>
    <select class="form-select" id="selectType">
        <option disabled selected>Type of addition</option>
...
<div class="d-none" id="form">
    ...
    <div class="d-none type" id="stocks">
        ...
        <div class="form-group">
            <label>Store</label>
            <select class="form-select required" id="storeStock" name="store_id">
                <option disabled selected>Select a store</option>
            </select>
        </div>
        <div class="form-group">
            <label>Product</label>
            <select class="form-select required" id="productStock" name="product_id">
