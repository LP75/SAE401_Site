/**
 * Function to initialize the sorting functionality and handle events.
 */
$(document).ready(function(){

    /**
     * Array to store unique product prices.
     * @type {number[]}
     */
    let prices = [];

    /**
     * Event handler for the change event on the selectOption dropdown.
     */
    ...
    /**
     * Event handler for the change event on the selectParameter dropdown.
     */
    ...
    /**
     * Event handler for the change event on the selectMin dropdown.
     */
    ...
    /**
     * Event handler for the change event on the selectMax dropdown.
     */
    ...
    /**
     * Function to display products within the selected price range.
     */
